...
class ElectricalCalculatorApp {
    ...
    setupModules() {
        ...
        this.modules.set('short-circuit', {
            ...
            component: () => Promise.resolve({ default: ShortCircuitModule })
        });
        ...
        this.modules.set('selectivity', {
            ...
            component: () => Promise.resolve({ default: SelectivityModule })
        });
        ...
        this.modules.set('power', {
            ...
            component: () => Promise.resolve({ default: PowerModule })
        });
        ...
        this.modules.set('energy', {
            ...
            component: () => Promise.resolve({ default: EnergyModule })
        });
        ...
        this.modules.set('protection', {
            ...
            component: () => Promise.resolve({ default: ProtectionModule })
        });
        ...
        this.modules.set('thermal', {
            ...
            component: () => Promise.resolve({ default: ThermalModule })
        });
        ...
        this.modules.set('battery', {
            ...
            component: () => Promise.resolve({ default: BatteryModule })
        });
        ...
        this.modules.set('voltage-drop', {
            ...
            component: () => Promise.resolve({ default: VoltageDropModule })
        });
        ...
        this.modules.set('transformer', {
            ...
            component: () => Promise.resolve({ default: null }) // TODO: Implement transformer module
        });
        ...
        this.modules.set('cable-sizing', {
            ...
            component: () => Promise.resolve({ default: null }) // TODO: Implement cable-sizing module
        });
        ...
        this.modules.set('motor-protection', {
            ...
            component: () => Promise.resolve({ default: null }) // TODO: Implement motor-protection module
        });
        ...
        this.modules.set('lightning-protection', {
            ...
            component: () => Promise.resolve({ default: null }) // TODO: Implement lightning-protection module
        });
    }
...
window.ElectricalCalculatorApp = ElectricalCalculatorApp;
window.Utils = Utils;
window.BaseModule = BaseModule;